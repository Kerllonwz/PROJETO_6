...
const menusByRestaurant: { [key: number]: MenuItem[] } = {
  ...
  2: [ // La Dolce Vita Trattoria
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1476124369491-c3e927ea1008?w=300&h=200&fit=crop',
      portion: 'Serve 1 pessoa',
      price: 48.90,
    },
    {
  ...
  4: [ // El Mariachi Mexicano
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1599974164705-471dc4d3d52c?w=300&h=200&fit=crop',
      portion: '3 unidades',
      price: 36.90,
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1603924187033-b6c8c5c69e4e?w=300&h=200&fit=crop',
      portion: 'Serve 2 pessoas',
      price: 24.90,
    },
  ],
  ...
  6: [ // Churrascaria Gaúcha
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1604085792782-8d92ff5c8d0f?w=300&h=200&fit=crop',
      portion: 'Serve 2 pessoas',
      price: 24.90,
    },
  ],
