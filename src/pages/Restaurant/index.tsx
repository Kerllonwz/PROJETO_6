...
const menusByRestaurant: { [key: number]: MenuItem[] } = {
  ...
  2: [ // La Dolce Vita Trattoria
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1633964913295-ceb43826ed35?w=300&h=200&fit=crop',
      portion: 'Serve 1 pessoa',
      price: 48.90,
    },
    {
  ...
  4: [ // El Mariachi Mexicano
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1534797258760-1bd2cc940a7a?w=300&h=200&fit=crop',
      portion: 'Serve 2 pessoas',
      price: 24.90,
    },
  ],
