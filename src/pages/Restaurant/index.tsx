...
const menusByRestaurant: { [key: number]: MenuItem[] } = {
  ...
  2: [ // La Dolce Vita Trattoria
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1595908129746-9fa11994e2db?w=300&h=200&fit=crop',
      portion: 'Serve 1 pessoa',
      price: 48.90,
    },
    {
  ...
  4: [ // El Mariachi Mexicano
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1621964550018-80fe504ed533?w=300&h=200&fit=crop',
      portion: 'Serve 2 pessoas',
      price: 24.90,
    },
  ],
